...
class Mediapipe:
    ...
    def hand_tracking(self, input_video, output_folder):
        ...
        api_func.RunMPPGraph.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p]
    ...
    def gesture_recognition(self, input_video, output_folder):
        ...
        coordinates_func.RunMPPGraph.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p]
